...
export default defineField({
  universalIdentifier: STANDARD_OBJECT_RELATION_FIELD_IDS.opportunityMortgageLeads,
  ...
  relationTargetFieldMetadataUniversalIdentifier: MORTGAGE_LEAD_FIELD_IDS.opportunity,
