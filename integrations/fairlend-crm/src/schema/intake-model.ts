...
const partnerFields: readonly FieldSpec[] = [
  ...
  {
    name: 'speakerLane',
    label: 'Speaker Opportunity Lane',
    description: 'Qualified presentation channel used to segment Elie speaker opportunities.',
  },
  { name: 'speakerOpportunityType', label: 'Speaker Opportunity Type' },
  {
    name: 'opportunitySeriesKey',
    label: 'Opportunity Series Key',
    description: 'Stable normalized key for the recurring program or event series.',
    isUIEditable: false,
  },
  {
    name: 'eventOccurrenceKey',
    label: 'Event Occurrence Key',
    description: 'Stable normalized key for the researched event occurrence.',
    isUIEditable: false,
  },
  { name: 'speakerScore', label: 'Speaker Qualification Score', type: 'number' },
  { name: 'speakerTier', label: 'Speaker Opportunity Tier' },
  { name: 'opportunityFormat', label: 'Opportunity Format' },
  { name: 'opportunityTiming', label: 'Opportunity Timing', displayedMaxRows: 6 },
  { name: 'audienceProfile', label: 'Audience Profile', displayedMaxRows: 10 },
  { name: 'programEvidence', label: 'Program / Speaker Evidence', displayedMaxRows: 12 },
  { name: 'speakingAccess', label: 'Speaking Access', displayedMaxRows: 8 },
  { name: 'paidAccessDetails', label: 'Paid Access / Pricing', displayedMaxRows: 6 },
  { name: 'whyNow', label: 'Why Now', displayedMaxRows: 8 },
  { name: 'recommendedTalkTitle', label: 'Recommended Talk Title', displayedMaxRows: 4 },
  { name: 'talkPromise', label: 'Talk Promise', displayedMaxRows: 8 },
  { name: 'frontLoadedValue', label: 'Front-loaded Educational Value', displayedMaxRows: 12 },
  { name: 'audienceTakeaway', label: 'Audience Takeaway', displayedMaxRows: 8 },
  { name: 'drawFlowBridge', label: 'DrawFlow Bridge', displayedMaxRows: 10 },
  { name: 'researchGaps', label: 'Research Gaps / Reverification', displayedMaxRows: 10 },
  { name: 'sourceAccessSummary', label: 'Source Access Summary', displayedMaxRows: 8 },
...
const definitions: Record<IntakeObjectKind, IntakeDefinition> = {
  ...
  partner: {
    ...
    operationsFields: [
      ...
      'speakerLane', 'speakerScore', 'speakerTier', 'recommendedTalkTitle', 'speakingAccess',
