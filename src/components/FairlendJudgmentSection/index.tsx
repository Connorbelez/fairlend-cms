    ...
    >
      ...
      <Frame className="relative z-10 mx-auto w-full max-w-[1528px] rounded-2xl bg-muted/72 p-1 shadow-xs">
        <div className="grid gap-1 lg:grid-cols-[minmax(0,0.92fr)_minmax(360px,0.78fr)]">
          <Card
            className="relative isolate min-h-[520px] overflow-hidden rounded-xl border-[oklch(0.92_0.004_286.32)] bg-background shadow-[inset_0_1px_0_oklch(1_0_0/0.72)]"
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="absolute right-5 bottom-5 left-5 h-px bg-[linear-gradient(90deg,transparent,oklch(0.841_0.238_128.85),transparent)]"
            />
          </Card>
          ...
          >
            ...
            <CardContent className="relative z-10 grid min-h-[560px] content-between gap-10 p-6 sm:p-8 lg:p-10 xl:p-12">
              <div data-fairlend-about-copy>
                <span
                  aria-hidden="true"
                  className="mb-5 block h-1 w-10 rounded-full bg-[oklch(0.841_0.238_128.85)]"
              ...
              >
                {proofPoints.map(({ icon: Icon, label }) => (
                  <Card
                    className="rounded-xl border-[oklch(0.92_0.004_286.32)] bg-[oklch(0.967_0.001_286.375/0.64)] shadow-xs"
                    key={label}
                  >
