    ...
    <header className="flex h-12 shrink-0 items-center justify-between gap-2 border-b px-2">
      ...
      <div className="flex items-center gap-2">
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="size-6 bg-muted-foreground/5 rounded hidden sm:flex transition-colors duration-200 hover:bg-muted-foreground/10"
            >
          ...
          <PopoverContent align="end" className="w-64 p-4">
            <div className="mb-2">
              <h3 className="font-medium leading-none">Shortcuts</h3>
              <p className="text-sm text-muted-foreground">Quick access to your apps.</p>
            </div>
            <div className="grid grid-cols-3 gap-4 py-2">
              {['Email', 'Calendar', 'Files', 'Tasks', 'Notes', 'Chat'].map((app) => (
                <div
                  key={app}
                  className="flex flex-col items-center gap-1 cursor-pointer hover:bg-accent p-2 rounded-md transition-colors"
                >
          ...
          <PopoverContent align="end" className="w-80 p-0">
            ...
            <div className="max-h-64 overflow-y-auto">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="p-4 border-b last:border-0 hover:bg-accent cursor-pointer transition-colors"
                >
                  <p className="text-xs font-medium">New invoice created</p>
                  <p className="text-[10px] text-muted-foreground mt-1">
                    Invoice #INV-2024-{i} has been successfully generated.
                  </p>
            ...
            <div className="p-2 bg-muted/50 text-center">
              <Button variant="link" className="text-[10px] h-auto p-0">
        ...
        <Popover>
          ...
          <PopoverContent align="end" className="w-80 p-0">
            <div className="p-4 border-b">
              <h3 className="font-medium leading-none">Messages</h3>
            </div>
            <div className="max-h-64 overflow-y-auto">
              {[
