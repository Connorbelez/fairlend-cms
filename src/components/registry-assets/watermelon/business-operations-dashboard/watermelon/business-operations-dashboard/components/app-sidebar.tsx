...
import { IconBuildingSkyscraper, IconDots, IconSearch, IconPlus } from '@tabler/icons-react'
      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              size="lg"
              className="hover:bg-transparent px-1 group-data-[collapsible=icon]:flex group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:justify-center active:bg-transparent transition-all"
            >
              <div className="flex items-center w-full">
                ...
                <div className="flex flex-1 items-center gap-2 group-data-[collapsible=icon]:hidden px-2 min-w-0">
                  <span className="font-semibold truncate text-[15px] tracking-tight">
                    Ocean Labs
                  </span>
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="size-5 text-muted-foreground hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors ml-0.5 cursor-pointer"
                      >
