      ...
      <div className="flex items-center gap-1">
        <div className="flex items-center gap-2">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="h-9 w-9 rounded-md bg-neutral-100/50 dark:bg-neutral-800/50 hover:bg-neutral-200/50 dark:hover:bg-neutral-800 text-neutral-600 dark:text-neutral-300 border-t border-neutral-200 dark:border-neutral-700/80 relative transition-colors duration-300 group cursor-pointer"
          >
        ...
        <div className="flex items-center gap-2">
          <Select defaultValue="profile">
            ...
            >
              <SelectItem
                value="profile"
                className="focus:bg-neutral-100 dark:focus:bg-neutral-800 focus:text-neutral-900 dark:focus:text-neutral-100 cursor-pointer"
              >
                My Profile
              </SelectItem>
              <SelectItem
              ...
              <SelectItem
                value="logout"
                className="focus:bg-neutral-100 dark:focus:bg-neutral-800 focus:text-rose-600 dark:focus:text-rose-400 text-rose-500 cursor-pointer"
              >
                Logout
              </SelectItem>
            </SelectContent>
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px] bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800">
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="role" className="text-neutral-700 dark:text-neutral-300">
                    Role
                  </Label>
              ...
              <DialogFooter>
                <Button
                  type="submit"
                  className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white border-transparent cursor-pointer transition-colors duration-300 shadow-none"
                >
                  Send Invitation
                </Button>
              </DialogFooter>
