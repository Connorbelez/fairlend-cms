        ...
        <SidebarMenu className="border-b h-18 px-2 justify-center pt-2.5">
          <SidebarMenuItem>
            <SidebarMenuButton
              size="lg"
              asChild
              className="transition-colors duration-300 cursor-pointer hover:bg-transparent"
            >
              <div className="flex items-center justify-between">
                ...
                <div className="bg-neutral-100/50 dark:bg-neutral-800/50 hover:bg-neutral-200/50 dark:hover:bg-neutral-800 size-7 flex justify-center items-center rounded-sm transition-colors duration-300 cursor-pointer">
            ...
            <Collapsible open={open} onOpenChange={setOpen}>
              <CollapsibleTrigger asChild>
                <SidebarGroupLabel className="" asChild>
                  <div className="flex items-center justify-between gap-1.5 text-neutral-500! cursor-pointer transition-colors duration-300 hover:text-neutral-800 dark:hover:text-neutral-300 group">
                    Main Menu{' '}
                    {open ? (
        ...
        {showSecurityCard && (
          <div className="relative overflow-hidden rounded-lg bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-4 group transition-colors duration-300 cursor-pointer">
            ...
            <Button
              ...
              size="icon"
              className="text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-300 rounded-full border-y border-y-neutral-500/40 bg-neutral-500/10 absolute top-2 right-2 hover:bg-neutral-200/50 dark:hover:bg-neutral-800 transition-colors duration-300 cursor-pointer z-10"
            >
              <X className="size-4!" />
            </Button>

            <h3 className="text-neutral-900 dark:text-white font-medium tracking-tight mb-1.5">
              ...
              <DialogContent className="sm:max-w-[425px] bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800">
                ...
                <div className="flex flex-col items-center gap-4 py-4">
                  ...
                  <div className="grid w-full items-center gap-1.5">
                    <Label htmlFor="code" className="text-neutral-700 dark:text-neutral-300">
                      Authentication Code
                    </Label>
                    <Input
                      type="text"
                      id="code"
                      placeholder="000 000"
                      className="h-10 bg-neutral-100/50 dark:bg-neutral-800/50 border-neutral-200 dark:border-neutral-700 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none text-center tracking-widest text-lg text-foreground"
                    />
                  </div>
                </div>
                <DialogFooter>
                  <Button
                    type="submit"
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white border-transparent cursor-pointer transition-colors duration-300"
                  >
                    Verify and Enable
                  </Button>
                </DialogFooter>
