...
export const transactions = [
  {
    ...
    status: 'Pending',
    statusColor:
      'bg-yellow-100 text-yellow-800 dark:bg-yellow-500/15 dark:text-yellow-400 border-transparent dark:border-yellow-500/20',
  ...
  },
  {
    ...
    status: 'Completed',
    statusColor:
      'bg-green-100 text-green-800 dark:bg-green-500/15 dark:text-green-400 border-transparent dark:border-green-500/20',
    icon: IconArrowNarrowUp,
  ...
  },
  {
    ...
    status: 'Scheduled',
    statusColor:
      'bg-cyan-100 text-cyan-800 dark:bg-cyan-500/15 dark:text-cyan-400 border-transparent dark:border-cyan-500/20',
    icon: IconArrowNarrowUp,
