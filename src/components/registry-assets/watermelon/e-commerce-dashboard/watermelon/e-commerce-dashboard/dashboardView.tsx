      ...
      <div className="flex flex-col xl:flex-row gap-4 min-w-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 flex-1 min-w-0">
          {dashboardMetrics.map((metric) => {
            const TrendIcon =
              metric.trend === 'up' ? IconArrowNarrowUpDashed : IconArrowNarrowDownDashed
            return (
              <Card
                key={metric.id}
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b dark:border-neutral-800 hover:bg-transparent">
                    ...
                    <TableHead className="text-right font-medium text-muted-foreground w-[80px]"></TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
              ...
              <div className="w-full space-y-3">
                {trafficChannelData.map((channel) => (
                  <div key={channel.name} className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-semibold shrink-0">{channel.value}%</span>
                  </div>
                ))}
              </div>
            </CardContent>
