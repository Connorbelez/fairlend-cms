  ...
  return (
    <div className="flex flex-wrap items-center gap-3 p-4">
      <Select defaultValue="pipeline-value">
        <SelectTrigger className="w-fit cursor-pointer rounded-full! border-y border-neutral-200 bg-neutral-100 text-xs shadow-none transition-colors hover:bg-neutral-200/50 focus:ring-0 dark:border-neutral-600 dark:bg-neutral-800 dark:hover:bg-neutral-700/50">
      ...
      <Select defaultValue="any">
        <SelectTrigger className="w-fit cursor-pointer rounded-full border-y border-neutral-200 bg-neutral-100 text-xs shadow-none transition-colors hover:bg-neutral-200/50 focus:ring-0 dark:border-neutral-600 dark:bg-neutral-800 dark:hover:bg-neutral-700/50">
          <span className="text-xs text-neutral-500 dark:text-neutral-400">Stage</span>
      ...
      <Select defaultValue="7-days">
        <SelectTrigger className="w-fit cursor-pointer rounded-full border-y border-neutral-200 bg-neutral-100 text-xs shadow-none transition-colors hover:bg-neutral-200/50 focus:ring-0 dark:border-neutral-600 dark:bg-neutral-800 dark:hover:bg-neutral-700/50">
          <span className="text-xs text-neutral-500 dark:text-neutral-400">Last Activity</span>
