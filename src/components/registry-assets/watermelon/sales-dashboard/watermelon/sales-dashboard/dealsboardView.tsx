...
export const DealsBoardView = () => {
  const getDealsInStage = (stage: DealStage) => deals.filter((d) => d.stage === stage)
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Download the current deals board data.</DialogDescription>
              </DialogHeader>
              <DialogFooter>
                <DialogClose asChild>
        ...
        <div className="custom-scrollbar h-full overflow-x-auto p-5 pb-10">
          <div className="flex h-full w-max min-w-full gap-5">
            {DEAL_STAGES.map((stage) => {
              ...
              return (
                <div key={stage} className="flex w-[280px] shrink-0 flex-col sm:w-[300px]">
