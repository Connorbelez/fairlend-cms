...
export const segmentColors: Record<string, string> = {
  Enterprise:
    'border-blue-200 dark:border-blue-400/40 bg-blue-50 dark:bg-blue-400/20 text-blue-700 dark:text-blue-200',
  Upsell:
    'border-purple-200 dark:border-purple-400/40 bg-purple-50 dark:bg-purple-400/20 text-purple-700 dark:text-purple-200',
  'New Logo':
    'border-emerald-200 dark:border-emerald-400/40 bg-emerald-50 dark:bg-emerald-400/20 text-emerald-700 dark:text-emerald-200',
  Renewal:
    'border-emerald-200 dark:border-emerald-400/40 bg-emerald-50 dark:bg-emerald-400/20 text-emerald-700 dark:text-emerald-200',
  Expansion:
    'border-emerald-200 dark:border-emerald-400/40 bg-emerald-50 dark:bg-emerald-400/20 text-emerald-700 dark:text-emerald-200',
  Pilot:
    'border-orange-200 dark:border-orange-400/40 bg-orange-50 dark:bg-orange-400/20 text-orange-700 dark:text-orange-200',
  Strategic:
    'border-red-200 dark:border-red-400/40 bg-red-50 dark:bg-red-400/20 text-red-700 dark:text-red-200',
...
export const DEAL_STAGES: DealStage[] = ['Discovery', 'Proposal', 'Negotiation', 'Closed Won']
