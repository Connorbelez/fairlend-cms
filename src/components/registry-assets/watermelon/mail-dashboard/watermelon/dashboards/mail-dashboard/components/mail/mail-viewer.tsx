          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem className="gap-2">
                <IconShare className="size-4" /> Forward
              </DropdownMenuItem>
          ...
          <FieldContent className="gap-0">
            ...
            <div className="flex flex-col bg-background rounded-xl border border-border">
              ...
              <div className="p-3 flex items-center justify-between">
                ...
                <Button
                  size="sm"
                  className="bg-orange-600 hover:bg-orange-500 text-white rounded-full px-4 h-9 gap-2 font-medium shadow-[0_0_15px_rgba(249,115,22,0.3)] transition-colors hover:shadow-[0_0_20px_rgba(249,115,22,0.4)] outline-none focus-visible:ring-0"
                >
                  <span>Send</span>
