      ...
      <SidebarHeader className="border-b max-md:py-4 py-4 flex items-center justify-start group-data-[collapsible=icon]:justify-center px-4 group-data-[collapsible=icon]:px-0">
        <SidebarMenu className="flex items-center justify-start group-data-[collapsible=icon]:items-center">
          <SidebarMenuItem className="flex items-center justify-start w-full group-data-[collapsible=icon]:justify-center">
            <SidebarMenuButton
              size="lg"
              className="group-data-[collapsible=icon]:h-10! group-data-[collapsible=icon]:w-10! group-data-[collapsible=icon]:p-0! flex items-center justify-start group-data-[collapsible=icon]:justify-center bg-orange-600 text-white rounded-lg shadow-[inset_0px_1px_2px_rgba(255,255,255,0.4),inset_0px_-2px_4px_rgba(0,0,0,0.3)] px-3 group-data-[collapsible=icon]:px-0 gap-2"
            >
              <svg
                width="24"
                height="24"
              ...
              <span className="font-medium text-base  md:group-data-[collapsible=icon]:hidden">
                OceanLabs
              </span>
            </SidebarMenuButton>
          </SidebarMenuItem>
                  ...
                  <SidebarMenuItem key={item.title} className="w-full">
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="md:group-data-[collapsible=icon]:hidden font-medium">
                          {item.title}
                        </span>
                      </a>
                    </SidebarMenuButton>
