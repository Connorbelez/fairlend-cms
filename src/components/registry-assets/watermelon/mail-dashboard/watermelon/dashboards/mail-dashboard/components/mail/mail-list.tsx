    ...
    <div className="flex flex-col h-full bg-sidebar text-foreground overflow-hidden">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-3 p-3">
          <div className="text-[11px] font-bold text-muted-foreground uppercase px-1">Pinned</div>
      ...
      <Tabs defaultValue="email" className="flex-1 flex flex-col min-h-0 ">
        <div className="px-3 max-md:px-5 border-y border-border">
          <TabsList className="w-full bg-transparent justify-between gap-6 p-0 h-11!">
            <TabsTrigger
              value="email"
        ...
        <div className="px-2 py-2 border-b ">
          <Dialog>
            <DialogTrigger asChild>
              <Button
                variant="ghost"
                className="flex justify-start gap-3 w-full h-full pb-2 pt-0 text-muted-foreground hover:text-foreground transition-colors group hover:bg-transparent!"
              >
            ...
            <DialogContent className="sm:max-w-[500px]">
              <DialogHeader>
                ...
                <DialogDescription>Compose a new email or message.</DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-[150px] focus-visible:ring-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none transition-colors"
                  />
                </div>
              </div>
              <DialogFooter>
            ...
            {mails.map((mail) => {
              ...
              return (
                ...
                >
                  <div
                    className={cn(
                      'flex gap-3 p-2 max-md:px-4 transition-colors hover:bg-muted-foreground/5',
                    ...
                    <div className="flex-1 min-w-0 space-y-1 border-b pb-1">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 truncate">
                          <span
                            className={cn('text-[11px] font-medium truncate text-foreground/80')}
                          >
                            {mail.name}
                          </span>
                        </div>
