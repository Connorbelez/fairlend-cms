      ...
      <SidebarHeader className="gap-4 p-2">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
              className="border bg-white dark:bg-neutral-900 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-all active:scale-[0.98]"
            >
              <div className="flex w-full items-center">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-56">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem className="text-red-600 focus:bg-red-50 focus:text-red-600 dark:focus:bg-red-950/50">
                      Leave Workspace
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
