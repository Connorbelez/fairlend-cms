      ...
      <header className="h-12 flex items-start justify-between border-b-[1.5px] border-neutral-200 dark:border-neutral-800 shrink-0">
        <div className="flex items-center gap-1.5">
          <IconCalendarEvent
            ...
            strokeWidth={1.5}
          />
          <h1 className="text-sm font-semibold tracking-tight text-neutral-700 dark:text-neutral-200">
            Meetings
          </h1>
        </div>
          ...
          <Dialog>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                <Button
                  type="submit"
                  className="bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-500 dark:hover:bg-indigo-600 border-none"
                >
                  Schedule
                </Button>
              </DialogFooter>
              ...
              <Dialog>
                ...
                <DialogContent>
                  ...
                  <DialogFooter>
                    ...
                    <Button className="bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-500 dark:hover:bg-indigo-600 border-none">
                      Upload
                    </Button>
                  </DialogFooter>
                </DialogContent>
              ...
              <Dialog>
                ...
                <DialogContent>
                  ...
                  <DialogFooter>
                    <Button
                      type="submit"
                      className="w-full bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-500 dark:hover:bg-indigo-600 border-none"
                    >
                      Create Meeting
                    </Button>
                  </DialogFooter>
                ...
                >
                  <div className="flex items-center justify-between p-1 shrink-0">
                    <div className="flex items-center gap-1.5">
                      <Badge
                        variant="outline"
                        className={`h-6 rounded-full px-2.5 text-[11px] font-semibold border-[1.3px] ${
                          column.id === 'upcoming'
                            ...
                            : column.id === 'scheduled'
                              ...
                              : column.id === 'confirmed'
                                ? 'bg-green-50 text-green-500 border-green-100 dark:bg-green-500/10 dark:text-green-400 dark:border-green-500/20'
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          <DialogHeader>
                            ...
                            <DialogDescription>
                              Quickly add a meeting to this category.
                            </DialogDescription>
                          </DialogHeader>
