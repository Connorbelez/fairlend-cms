...
const STATUSES = [
  {
    label: 'Active',
    icon: <Circle className="size-3 fill-emerald-500 text-emerald-500" />,
    color: 'text-emerald-500',
  },
  {
    label: 'In Progress',
    icon: <Clock className="size-3 text-blue-400" />,
    color: 'text-blue-400',
  },
  { label: 'Blocked', icon: <Ban className="size-3 text-red-400" />, color: 'text-red-400' },
  {
    label: 'Done',
    icon: <CheckCircle2 className="size-3 text-neutral-400" />,
    ...
    <div className="flex flex-col min-h-full lg:h-full bg-white dark:bg-neutral-950 font-mono p-2.5 gap-2.5">
      ...
      <div className="flex items-center overflow-x-auto no-scrollbar gap-2">
        ...
        <div className="flex items-center gap-0.5 flex-nowrap whitespace-nowrap">
          <div className="flex items-center shrink-0 gap-2 px-2 py-1.5 bg-neutral-100 dark:bg-neutral-900 rounded-l-md transition-colors duration-150 cursor-pointer group hover:bg-neutral-200/60 dark:hover:bg-zinc-900/50 flex-nowrap whitespace-nowrap">
            <span className="text-neutral-400 dark:text-neutral-700 text-xs font-medium whitespace-nowrap">
              MF-214 ·
            </span>
            <span className="text-orange-500 dark:text-orange-300 font-medium whitespace-nowrap text-xs">
              Repair Context Graph Routing
            </span>
          ...
          <div className="flex items-center shrink-0 gap-2 px-2 py-1.5 bg-neutral-100 dark:bg-neutral-900 transition-colors duration-150 cursor-pointer group hover:bg-neutral-200/60 dark:hover:bg-zinc-900/50 flex-nowrap whitespace-nowrap">
            ...
            <span className="text-green-600 dark:text-green-300 font-medium whitespace-nowrap text-xs">
              Rebuild Left-Rail Grouping
            </span>
            <X className="size-4 text-neutral-400 dark:text-neutral-500 shrink-0 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors" />
          </div>
          <div className="flex items-center shrink-0 gap-2 px-2 py-1.5 bg-neutral-100 dark:bg-neutral-900 rounded-r-md transition-colors duration-150 cursor-pointer group hover:bg-neutral-200/60 dark:hover:bg-zinc-900/50 flex-nowrap whitespace-nowrap">
            ...
            <span className="text-lime-600 dark:text-lime-300 font-medium whitespace-nowrap text-xs">
      ...
      <div className="flex flex-col lg:flex-row lg:flex-1 lg:overflow-hidden gap-2">
        ...
        <div className="w-full lg:w-[60%] flex flex-col border rounded-md border-neutral-200 dark:border-zinc-800/60 lg:h-full overflow-hidden">
          <ScrollArea className="flex-1 lg:h-full">
            <div className="px-4 py-8 md:px-10 md:py-14 lg:px-20 lg:pt-20 max-w-3xl mx-auto w-full">
              ...
              <div className="flex items-center gap-3 mb-5">
                <span className="text-neutral-600 dark:text-neutral-300 px-2 py-0.5 rounded-sm tracking-tight text-xs ring-1 ring-neutral-200 dark:ring-neutral-500/20">
                  MF-214
                </span>
                <Badge
                  variant="outline"
                  className="border-none rounded-sm text-neutral-500 dark:text-neutral-700 text-xs px-2 py-0.5 flex items-center gap-1.5 ring-1 ring-neutral-200 dark:ring-neutral-500/20"
                >
                  <IconAlertCircleFilled className="size-3.5 text-orange-400" />
                  Waiting on{' '}
                  <span className="cursor-pointer text-cyan-600 dark:text-cyan-300 font-light">
                    MF-209
                  </span>
                </Badge>
              </div>
              ...
              <div className="relative mb-12 group flex gap-4 items-start">
                ...
                <p className="text-neutral-400 dark:text-neutral-700 leading-normal text-xs max-w-xl font-normal">
                  Our retrieval layer is returning &quot;related&quot; items that feel random, and
                  the left rail isn&apos;t reflecting what users actually open or reference. We need
                  a clearer linking logic, better grouping signals, and a ranking pass that favors
                  real intent over noisy similarity.
                </p>
              </div>
              ...
              <div className="border-y border-neutral-200 dark:border-neutral-800/60 py-1.5 mb-14">
                <div className="flex flex-wrap items-center gap-0.5 text-neutral-700 dark:text-neutral-300 lg:flex-nowrap lg:overflow-x-auto lg:no-scrollbar">
                  ...
                  <Popover>
                    ...
                    <PopoverContent
                      className="w-44 p-1.5 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl rounded-lg font-mono"
                      align="start"
                    >
                      <p className="text-[10px] text-neutral-400 dark:text-neutral-600 px-2 py-1 uppercase tracking-widest">
                        Status
                      </p>
                      {STATUSES.map((s) => (
                        <button
                        ...
                        >
                          ...
                          <span>{s.label}</span>
                          {status === s.label && (
                            <Check className="size-3 ml-auto text-neutral-400" />
                          )}
                        </button>
                      ))}
                    </PopoverContent>
          ...
          sizes="96px"/>
                    ...
                    <PopoverContent
                      className="w-52 p-1.5 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl rounded-lg font-mono"
                      align="start"
                    >
                      <p className="text-[10px] text-neutral-400 dark:text-neutral-600 px-2 py-1 uppercase tracking-widest">
                        Assignees
          ...
          sizes="96px"/>
                  ...
                  <Popover>
                    ...
                    <PopoverContent
                      className="w-48 p-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 shadow-xl rounded-lg font-mono"
                      align="start"
                    >
                      <p className="text-[10px] text-neutral-400 dark:text-neutral-600 px-1 pb-2 uppercase tracking-widest">
                        Story Points
                      </p>
                      <div className="flex flex-wrap gap-1.5">
                        {EFFORT_POINTS.map((pt) => (
                          <button
                            key={pt}
                            onClick={() => setEffort(effort === pt ? null : pt)}
                        ...
                        >
                          <CardHeader className="p-3 flex flex-row items-start gap-2 border-b-[1.5px] border-neutral-200 dark:border-neutral-800/60">
                            ...
                            <div className="space-y-0.5">
                              <CardTitle className="text-sm text-neutral-700 dark:text-neutral-100 font-normal group-hover:text-neutral-900 dark:group-hover:text-white transition-colors leading-tight tracking-tight">
                                {item.title}
                              </CardTitle>
                              <CardDescription className="text-xs text-neutral-400 dark:text-neutral-600 font-medium">
                                {item.id}
                              </CardDescription>
                            </div>
                          </CardHeader>
                          <CardContent className="p-4 space-y-5">
                            <div className="space-y-4">
                              <div className="flex items-center gap-4 text-xs">
                                ...
                                <span className="text-neutral-700 dark:text-neutral-300 font-bold leading-relaxed truncate">
                                  {item.origin}
                                </span>
                              </div>
                              <div className="flex items-center gap-4 text-xs">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                              <Badge
                                variant="outline"
                                className="bg-neutral-100 dark:bg-neutral-900/60 text-neutral-500 dark:text-neutral-500 border-none rounded-full py-1.5 px-2.5 text-xs ring-1 ring-neutral-300 dark:ring-neutral-800/60 flex items-center gap-1.5 hover:text-neutral-700 dark:hover:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors duration-150 cursor-pointer"
                              >
                ...
                <div className="flex items-end gap-3">
                  ...
                  <div className="flex flex-col gap-2 flex-1">
                    ...
                    <div className="text-xs w-full max-w-[95%] lg:max-w-[90%] bg-neutral-100 dark:bg-neutral-900 px-3.5 py-2.5 text-neutral-700 dark:text-neutral-200 rounded-xl ">
                      Some &quot;related&quot; items are missing while random ones appear. We need a
                      stronger signal pipeline.
                    </div>
                    <div className="text-xs w-full max-w-[95%] lg:max-w-[90%] bg-neutral-100 dark:bg-neutral-900 px-3.5 py-2.5 text-neutral-700 dark:text-neutral-200 rounded-xl rounded-tl-sm">
                      The graph is linking nodes that share tokens, not meaning. Maybe we add
      ...
      <Dialog open={addItemOpen} onOpenChange={setAddItemOpen}>
        <DialogContent className="bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 font-mono sm:max-w-md rounded-xl shadow-2xl">
          <DialogHeader>
            <DialogTitle className="text-neutral-800 dark:text-neutral-100 text-sm font-semibold">
              Add Work Item
            </DialogTitle>
