      ...
      >
        <SidebarHeader className="p-4 gap-4">
            ...
            <SidebarMenuItem>
              <SidebarMenuButton size="lg" className="hover:bg-transparent! px-0">
                ...
                <div className="flex flex-col gap-0.5 leading-none">
                  <span className="font-semibold text-neutral-900 dark:text-neutral-100 text-[15px] tracking-wide truncate">
                    OceanLabs
                  </span>
          ...
          <div className="relative group-data-[collapsible=icon]:hidden">
            ...
            />
            <Search
              className="absolute left-3 top-1/2 -translate-y-1/2 size-4 text-neutral-400 dark:text-neutral-600"
              strokeWidth={2}
            />
          ...
          <SidebarGroup className="mt-2">
            <SidebarMenu className="space-y-1">
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive
                  className="group/menu-button h-9 gap-x-3 text-neutral-500 dark:text-neutral-400 font-medium text-[13px] hover:bg-neutral-100 dark:hover:bg-neutral-900! hover:text-neutral-900 dark:hover:text-white! dark:data-[active=true]:text-white! dark:data-[active=true]:bg-neutral-900! transition-colors duration-150"
                >
                  <Layers
                    className="size-5 opacity-70 group-hover/menu-button:opacity-100 group-data-[active=true]/menu-button:opacity-100 transition-opacity"
                    strokeWidth={2}
                  />
                  <span>Queue</span>
                ...
                <CollapsibleTrigger asChild>
                  <SidebarMenuButton className="flex items-center gap-2.5 px-2 py-1.5 text-neutral-500 dark:text-neutral-400 mb-2 hover:bg-neutral-100 dark:hover:bg-neutral-900! hover:text-neutral-900 dark:hover:text-white! transition-colors duration-150 cursor-pointer group">
                    <div className="relative size-4 shrink-0 flex items-center justify-center">
                      <Plus
                        className="size-4 opacity-70 group-hover:opacity-100 transition-opacity absolute group-data-[state=open]/collapsible:hidden"
                        strokeWidth={2}
                      />
                      <Minus
                        className="size-4 opacity-70 group-hover:opacity-100 transition-opacity absolute hidden group-data-[state=open]/collapsible:block"
                        strokeWidth={2}
                      />
                    </div>
        ...
        <SidebarFooter className="p-4 pb-6 space-y-6">
          <Card className="rounded-xl border border-neutral-200 dark:border-neutral-800/60 bg-white dark:bg-neutral-900/40 p-4 shadow-sm relative overflow-hidden gap-0 hidden md:flex">
            ...
            <CardContent className="p-0 relative">
              <CardTitle className="font-semibold text-neutral-800 dark:text-neutral-100 mb-1.5 text-[13px] leading-none">
                You&apos;re on Starter access
              </CardTitle>
          ...
          <SidebarMenu className="space-y-1">
            <SidebarMenuItem>
              <SidebarMenuButton className="group/menu-button h-9 gap-x-3 text-neutral-500 dark:text-neutral-400 text-[13px] hover:bg-neutral-100 dark:hover:bg-neutral-900! hover:text-neutral-900 dark:hover:text-white! transition-colors duration-150">
                <HelpCircle
                  className="size-[18px] opacity-70 group-hover/menu-button:opacity-100 transition-opacity"
                  strokeWidth={2}
                />
                <span>Support</span>
              </SidebarMenuButton>
            ...
            <SidebarMenuItem className="mt-1">
              <SidebarMenuButton
                className="group/menu-button h-10 gap-x-3 text-neutral-500 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-neutral-900/80! text-[13px] hover:text-neutral-900 dark:hover:text-white! transition-colors duration-150"
                size="lg"
              >
