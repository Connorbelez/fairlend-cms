...
import {
  ...
  investigatingCards,
  resolvedCards,
} from './components/active-streams/constants'
    ...
    <div className="flex-1 flex flex-col w-full bg-white dark:bg-neutral-950 overflow-hidden min-h-0">
      ...
      <div className="py-4 px-7 flex items-start justify-between">
        <div className="flex flex-col gap-0">
          <h1 className="text-2xl font-medium tracking-tighter text-neutral-900 dark:text-neutral-100">
            Activity stream
          </h1>
          <p className="text-neutral-500 dark:text-neutral-400 text-base tracking-tight">
            Real-time system activity across teams
          </p>
        </div>
      ...
      <Tabs defaultValue="flowView" className="flex-1 flex flex-col min-h-0">
        ...
        <div className="px-6 border-b dark:border-neutral-800 overflow-x-auto scrollbar-hide">
          <TabsList className="bg-transparent h-16 p-0 gap-6 max-md:w-max justify-start">
            {[
              ...
              >
                <tab.icon
                  className="size-5 text-neutral-400 dark:text-neutral-500 group-data-[state=active]:text-orange-500 dark:group-data-[state=active]:text-orange-500 transition-colors duration-300"
                  strokeWidth={1.5}
                />
        ...
        <TabsContent
          value="flowView"
          className="flex-1 flex flex-col p-6 pt-3 bg-white dark:bg-neutral-950 overflow-hidden gap-7 min-h-0"
        >
          {/* Filters */}
          <div className="flex flex-wrap items-center gap-4">
            <Button
              variant="outline"
              className="bg-neutral-200/50 dark:bg-neutral-900/50 hover:bg-[#f2f2f2] dark:hover:bg-neutral-800 border-neutral-100/50 dark:border-neutral-800/50 rounded-lg px-3 flex items-center gap-3 font-medium text-neutral-800 dark:text-neutral-200 shadow-none transition-colors duration-300 cursor-pointer"
            >
              Filter
              <Badge
                variant="secondary"
                className="bg-white dark:bg-neutral-800 text-neutral-500 dark:text-neutral-400 rounded px-2 py-0.5 size-4 flex justify-center shadow border dark:border-neutral-700"
              >
                0
              </Badge>
            </Button>
          ...
          <div className="flex-1 flex gap-6 overflow-auto over min-h-0 scrollbar-hide">
            ...
            <KanbanColumn
              title="Acknowledged"
              count={4}
              cards={acknowledgedCards}
              icon={IconHourglass}
            />
            <KanbanColumn
              title="Investigating"
              count={1}
              cards={investigatingCards}
              icon={IconSettings}
            />
