  ...
  <Card className="shadow-none bg-neutral-200/35 dark:bg-neutral-900 rounded-lg border-none px-3 py-2.5 gap-3 transition-colors duration-300 hover:bg-muted/50 cursor-pointer group">
    <CardHeader className="p-0 flex flex-row items-start justify-between space-y-0">
      <div className="flex gap-2">
        <div
          className={cn(
            'size-7 rounded-sm flex items-center justify-center text-white shadow-sm',
            card.logoBg,
          )}
        >
          {card.logo}
        ...
        <div className="grid gap-0.5">
          <h4 className="text-base font-medium leading-tight tracking-tight text-neutral-900 dark:text-neutral-100">
            {card.title}
          </h4>
      ...
      <div className="grid gap-2.5 py-1 dark:border-neutral-800/50">
        {[
          ...
          <div key={detail.label} className="flex items-center gap-12 text-[14px]">
            ...
            <span className="text-neutral-900 dark:text-neutral-100 text-xs font-semibold tracking-tight max-md:truncate max-md:max-w-[100px]">
              {detail.value}
            </span>
          </div>
        ))}
