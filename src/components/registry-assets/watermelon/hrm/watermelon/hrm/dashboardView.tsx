...
import { Users, Calendar, BriefcaseBusiness, Info, ScanFace } from 'lucide-react'
...
export const DashboardView = () => {
  return (
    <div className="min-h-full w-full p-6">
      <div className="mb-6">
        <h1 className="text-2xl tracking-tight text-foreground mb-1">Welcome To, GR8R HRM!</h1>
        <p className="text-sm text-muted-foreground/40">Manage candidate and track application</p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-1">
                <p className="text-xs text-muted-foreground font-medium tracking">{card.title}</p>
                <div className={`bg-muted p-1 rounded`}>
                  <IconComponent className={`size-3 ${card.iconColor}`} />
                </div>
              </div>
              <p className="text-2xl font-medium text-foreground mb-3">{card.value}</p>
              <div className="flex items-center justify-between">
                <p className="text-xs text-neutral-500 font-medium">{card.subtitle}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-2 bg-card border rounded-lg border-border p-4 transition-colors duration-300 shadow-none">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4 border-b-[1.5px] border-border border-dashed pb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-medium text-foreground">Attendance Overview</h3>
            </div>
          ...
          <ChartContainer config={attendanceChartConfig} className="h-[270px] w-full">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-1 flex flex-col md:flex-row lg:flex-col gap-4">
          ...
          <div className="flex-1 bg-card border rounded-lg border-border p-4 transition-colors duration-300 hover:bg-muted/50 cursor-pointer group shadow-none">
            ...
            <ChartContainer config={jobChartConfig} className="!aspect-auto h-[90px] w-full">
              <PieChart>
                <Pie
          ...
          <Tabs defaultValue="list" className="w-full gap-4">
            <div className="flex w-full flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className=" font-medium text-foreground">Employee Activities</h3>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 max-md:justify-end">
                ...
                <div className="flex items-center gap-2">
                  <Select defaultValue="pipeline-value">
                    <SelectTrigger className="w-fit py-[17px] text-xs bg-muted/50 transition-colors duration-300 cursor-pointer shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        size="icon"
                        className="!size-9 transition-colors duration-300 cursor-pointer shadow-none"
                      >
                        ...
                        <div className="grid gap-3">
                          <div className="grid grid-cols-3 items-center gap-4">
                            ...
                            <Select defaultValue="all">
                              <SelectTrigger
                                id="department"
                                className="col-span-2 h-8 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none"
                              >
