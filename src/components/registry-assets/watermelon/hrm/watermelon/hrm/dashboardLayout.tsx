    ...
    <TooltipProvider delayDuration={0}>
      <div className="flex h-screen overflow-hidden bg-background">
        ...
        <div className="hidden lg:flex h-full shrink-0">
          <IconRail onToggle={() => setSidebarOpen(!sidebarOpen)} isExpanded={sidebarOpen} />
          ...
          <header className="flex h-14 shrink-0 items-center justify-between gap-2 border-b border-border px-4 lg:px-6">
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                ...
                <SheetContent
                  side="left"
                  className="p-0 w-fit flex flex-row gap-0 h-full border-none bg-transparent no-scrollbar [&>button]:hidden"
                >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="w-56 mt-1.5 rounded-xl border-sidebar-border bg-sidebar text-sidebar-foreground shadow-lg"
              >
