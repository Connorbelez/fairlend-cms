        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-none">
              <TableHead className="w-[80px] text-muted-foreground font-medium border-r pl-3">
                #ID
              </TableHead>
              ...
              <TableHead className="text-muted-foreground font-medium border-r">
                Department
              </TableHead>
              ...
              <TableHead className="text-right text-muted-foreground font-medium pr-3">
                Status
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {employees.map((employee) => (
              ...
              >
                <TableCell className="font-medium  pl-2 py-2">{employee.id}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-right">
                  <Badge
                    variant="secondary"
                    className={cn('font-medium border-0', statusStyles[employee.status])}
                  >
                    {employee.status}
                  </Badge>
                </TableCell>
