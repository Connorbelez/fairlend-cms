  ...
  return (
    ...
    >
      ...
      <div className="relative pt-24 sm:py-24 lg:py-28 overflow-visible">
        ...
        <div
          className="pointer-events-none absolute left-10 sm:left-1/3 lg:left-[30%] 2xl:left-[35%] top-1/3 lg:top-[41%] 2xl:top-[48%] -translate-x-1/2 -translate-y-1/2 w-60 sm:w-72 md:w-80 lg:w-[500px] 2xl:w-[600px] z-0 rounded-full blur-3xl"
          style={{
            background: 'radial-gradient(closest-side, rgba(236,72,153,0.35), transparent)',
          }}
        />
        <div
          className="pointer-events-none absolute right-10 sm:right-1/3 lg:right-[31%] 2xl:right-[35%] top-30 lg:top-[61%] translate-x-1/2 -translate-y-1/2 w-56 sm:w-72 md:w-80 lg:w-[500px] 2xl:w-[550px] z-0 rounded-full blur-3xl"
          style={{
            ...
            <div className="flex flex-wrap items-center gap-2 relative">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown
                    size={18}
                    className={`ml-1 transition-transform ${normalOpen ? 'rotate-180' : ''}`}
                  />
                </button>
                {normalOpen && (
              ...
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown
                    size={18}
                    className={`ml-1 transition-transform ${deepThinkOpen ? 'rotate-180' : ''}`}
                  />
                </button>
                {deepThinkOpen && (
