...
const UserProfile = () => (
  <div className="flex items-center space-x-3">
    <div className="w-10 h-10 rounded-lg  flex bg-[#9A6F6F] items-center justify-center font-semibold">
      AC
    </div>
    <div>
    ...
    <>
      ...
      >
        <div className="flex items-center gap-18 justify-start">
          <div id="logo" className="text-[34px] font-semibold tracking-wider">
            Adorable
          </div>
          <nav className="hidden md:flex items-center gap-10">
            <a href="#" className="font-regular text-lg">
              Community
            </a>
            <a href="#" className="font-regular text-lg">
              Pricing
          ...
          >
            <div className="pt-16">
              <motion.a
                ...
                href="#"
                className="block text-center text-xl font-regular py-2"
              ...
              <motion.div
                variants={menuItemVariants}
                className="border-t-[0.2px] border-gray-400/20 w-full pt-6 mt-4 flex justify-center"
              >
                <UserProfile />
              </motion.div>
            </div>
