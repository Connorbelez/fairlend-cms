...
export const integrationsData: Integration[] = [
  {
    id: 'slack',
    name: 'Slack',
    description: 'Get instant task notifications directly from Slack for seamless communication.',
    icon: Slack,
    connected: false,
  },
  {
    id: 'notion',
    name: 'Notion',
    description: 'Link Notion pages to centralize documentation synchronized across platforms.',
    icon: NotebookIcon,
    connected: false,
  },
  {
    ...
    description: 'Post task updates from conversations directly to your platform.',
    icon: MessageSquare,
    connected: false,
  },
  {
    id: 'trello',
    name: 'Trello',
    description: 'Sync Trello boards and cards with TaskFlow for unified project management.',
    icon: Trello,
    connected: true,
