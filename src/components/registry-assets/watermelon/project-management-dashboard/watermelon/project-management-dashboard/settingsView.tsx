  ...
  return (
    <div className="w-full h-full px-3 flex flex-col pt-3 md:pt-0">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-neutral-200">
        <h1 className="text-3xl text-neutral-700 dark:text-neutral-100 tracking-tighter">
          Settings
        </h1>
              ...
              <DialogHeader className="px-4 py-2 flex flex-row items-center justify-between border-b border-border">
                ...
                <div className="flex items-center gap-1">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="size-8 transition-colors hover:bg-muted outline-none focus-visible:ring-0"
                  >
                  ...
                  <div className="bg-background flex-1 rounded-md flex flex-col gap-4">
                    <div className="bg-secondary/30 rounded-lg p-2">
                      ...
                      <Select defaultValue={selectedIntegration.defaultBoard}>
                        ...
                        <SelectContent>
                          <SelectItem value={selectedIntegration.defaultBoard || 'default'}>
                    ...
                    <div className="bg-secondary/30 rounded-lg p-2">
                      ...
                      <Select defaultValue={selectedIntegration.syncDirection}>
                        ...
                        <SelectContent>
                          <SelectItem value="Two-way Sync">Two-way Sync</SelectItem>
                          <SelectItem value="One-way Sync">One-way Sync</SelectItem>
                    ...
                    {/* Automatic Actions */}
                    {selectedIntegration.actions && selectedIntegration.actions.length > 0 && (
                      <div className="bg-secondary/30 rounded-lg p-2">
                          ...
                          {selectedIntegration.actions.map((action, index) => (
                            <div
                              ...
                              className={`flex items-center justify-between p-3 ${
                                index !== selectedIntegration.actions!.length - 1
