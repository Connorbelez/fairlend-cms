...
export const InvoiceView = ({ isPreviewHidden }: { isPreviewHidden?: boolean }) => {
  ...
  const handleItemChange = (index: number, field: keyof InvoiceItem, value: string): void => {
    ...
    if (field === 'qty' || field === 'cost') {
      updatedItems[index].total = updatedItems[index].qty * updatedItems[index].cost
    }
    setInvoice((prev: Invoice) => ({
      ...prev,
      items: updatedItems,
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-full w-full lg:overflow-hidden">
        ...
        >
          <div className="space-y-6">
            ...
            {/* Client Details */}
            <div>
              <h3 className="font-semibold mb-3 text-foreground/90 tracking-tight">Billed By</h3>
              <div className="space-y-3 p-3 rounded-xl border border-border bg-background/30 px-4 py-4 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors duration-300 shadow-none">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('billedByName', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('billedByEmail', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('billedByAddress', e.target.value)}
            ...
            {/* Billed To */}
            <div>
              <h3 className="font-semibold mb-3 text-foreground/90 tracking-tight">Billed To</h3>
              <div className="space-y-3 p-3 rounded-xl border border-border bg-background/30 px-4 py-4 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors duration-300 shadow-none">
                <div>
                  <label className="text-xs text-muted-foreground mb-1 block font-medium">
                    Company
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('billedToCompany', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('billedToEmail', e.target.value)}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('billedToAddress', e.target.value)}
                    placeholder="Street Address"
                    className="h-9 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none text-foreground"
                  />
                </div>
            ...
            {/* Dates */}
            <div>
              <h3 className="font-semibold mb-3 text-foreground/90 tracking-tight">Dates</h3>
            ...
            <div>
              ...
              <div className="space-y-3">
                {invoice.items.map((item, index) => (
                  <div
                    key={index}
                    className="border border-border bg-background/30 rounded-xl p-4 space-y-3 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors duration-300 shadow-none"
                  >
        ...
        >
          <div className="w-full min-h-full h-fit flex justify-center p-4 sm:p-8 lg:p-10">
            ...
            >
              <div className="absolute top-0 right-0 w-[40px] h-[40px] rounded-bl-xl bg-neutral-50 dark:bg-neutral-800 border-border border-l-[1.5px] border-b-[1.5px]"></div>
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-8 mb-6 sm:mb-8">
                  <div>
                    ...
                    <div className="text-[10px] lg:text-sm leading-relaxed">
                      <p className="font-semibold text-foreground">{invoice.billedByName}</p>
                      <p className="text-muted-foreground">{invoice.billedByEmail}</p>
                      <p className="text-muted-foreground">{invoice.billedByAddress}</p>
                    </div>
                  </div>
                  <div>
                    <h3 className="text-xs lg:text-sm font-semibold text-muted-foreground mb-2 sm:mb-3">
                    ...
                    <div className="text-[10px] lg:text-sm leading-relaxed">
                      <p className="font-semibold text-foreground">{invoice.billedToCompany}</p>
