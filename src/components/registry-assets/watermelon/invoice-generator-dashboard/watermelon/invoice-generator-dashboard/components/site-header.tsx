        ...
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem className="hidden md:block">
              <BreadcrumbLink href="#" className="text-xl text-foreground font-semibold">
                {currentView}
              </BreadcrumbLink>
            </BreadcrumbItem>
          </BreadcrumbList>
        ...
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px]" onOpenAutoFocus={(e) => e.preventDefault()}>
            ...
            <div className="flex justify-end">
              <Button
                type="submit"
                className="bg-neutral-900 border-none dark:bg-neutral-800 hover:bg-neutral-800 dark:hover:bg-neutral-700 text-white"
              >
                Confirm & Send
              </Button>
            </div>
