    ...
    <div className="w-full h-full overflow-y-auto p-4 md:p-5 space-y-5">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="gap-1 transition-colors duration-300 cursor-pointer border-[1.5px] border-neutral-300 hover:border-neutral-400 dark:border-neutral-700 hover:dark:border-neutral-600"
                >
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Create a new item here.</DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    <Input
                      ...
                      className="focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 text-foreground"
                    />
                  </div>
                </div>
                <DialogFooter>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0 scrollbar-hide">
              ...
              <Button
                variant="outline"
                size="sm"
                className="gap-2 group bg-transparent! tracking-tight font-normal shrink-0 hover:border-neutral-300 shadow-none"
              >
                <Calendar className="h-4 w-4 text-neutral-500 group-hover:text-orange-500 transition-colors duration-100 cursor-pointer" />
                <span className="hidden sm:inline">Sep 28, 2025</span>{' '}
                <MoveRight className="h-4 w-4 text-neutral-500 group-hover:dark:text-neutral-300 group-hover:text-neutral-600  transition-all duration-100" />{' '}
                <span className="hidden sm:inline">Oct 4, 2025</span>
            ...
            <div className="flex items-center justify-between w-full sm:w-auto gap-4">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                ...
                />
                <span className="text-sm tracking-tight">Demo data</span>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      size="sm"
                      className="gap-2 transition-colors duration-300 cursor-pointer"
                    >
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      variant="outline"
                      size="icon"
                      className="md:hidden size-8 transition-colors duration-300 cursor-pointer"
                    >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center gap-3 w-full sm:w-auto">
              <Select defaultValue="acme">
                <SelectTrigger className="px-2 w-full sm:w-fit bg-background! group shadow-none hover:dark:bg-neutral-700/30! transition-colors duration-300 cursor-pointer hover:bg-neutral-200/20!">
                  <div className="flex items-center gap-1.5">
              ...
              <Select defaultValue="all">
                <SelectTrigger className="px-2 w-full sm:w-fit bg-background! group shadow-none hover:bg-neutral-200/20! hover:dark:bg-neutral-700/30! transition-colors duration-300 cursor-pointer">
                  <div className="flex items-center gap-1.5">
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="font-normal w-full sm:w-auto transition-colors duration-300 cursor-pointer group shadow-none hover:bg-neutral-200/20! hover:dark:bg-neutral-700/30!"
                >
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Share your thoughts or suggestions with us.</DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    <textarea
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4">
        {metricsData.map((metric, index) => (
          <Card
            key={index}
            className="border-border p-4 bg-background gap-0 shadow-none transition-colors duration-300 cursor-pointer hover:bg-neutral-200/10! hover:dark:bg-neutral-700/20!"
          >
            <CardHeader className="flex items-center justify-between p-0 mb-1">
              <div className="flex items-center gap-2">
                <span
                  className={`size-4.5 rounded ${metric.color} flex items-center justify-center`}
                >
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="ghost"
                    className="h-5 w-5 px-0! text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-100 rounded-sm transition-colors duration-300 cursor-pointer group hover:bg-neutral-200/40! hover:dark:bg-neutral-700/30!"
                  >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <Card className="lg:col-span-2 bg-background border-neutral-200 dark:border-border p-4 gap-3 overflow-hidden shadow-none ">
          <CardHeader className="flex flex-row items-center gap-2 p-0">
            ...
            <CardTitle className="text-sm font-medium">Team Performances Breakdown</CardTitle>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-6 w-6 ml-auto transition-all duration-300 text-neutral-400 dark:text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-100 cursor-pointer hover:bg-neutral-200/40! hover:dark:bg-neutral-700/30! group"
                >
                ...
                <Table>
                  ...
                  <TableBody>
                    {teamData.map((member) => (
                      <TableRow
                        key={member.id}
                        className="border-neutral-200 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-muted/30 transition-colors"
                      >
                        ...
                        <TableCell className="border-r border-neutral-200 dark:border-border">
                          <div className="flex items-center gap-1">
                            <span
                              className={`flex items-center gap-0.5 ${member.latesUp ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`}
                            >
                              {member.latesUp ? (
                        ...
                        <TableCell className="border-r border-neutral-200 dark:border-border">
                          <div className="flex items-center gap-1">
                            <span
                              className={`flex items-center gap-0.5 ${member.shiftsUp ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`}
                            >
                              {member.shiftsUp ? (
                                <TrendingUp className="size-3" />
                              ) : (
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1">
                            <span
                              className={`flex items-center gap-0.5 ${member.latePercentUp ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}`}
                            >
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-6 w-6 ml-auto transition-all duration-300 cursor-pointer hover:bg-neutral-200/40! hover:dark:bg-neutral-700/30! group text-neutral-400 dark:text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-100"
                >
                  <MoreVertical className="h-3 w-3 transition-colors duration-300" />
                </Button>
              </DropdownMenuTrigger>
                ...
                >
                  ...
                  {item.actionText ? (
                    <Button
                      variant="outline"
                      size="sm"
                      className="h-7 text-xs transition-colors duration-300 hover:bg-neutral-200/20 dark:hover:bg-neutral-800/40"
                    >
                      {item.actionText}
                    </Button>
                  ) : (
                    <Button
                      variant="outline"
                      size="icon"
                      className="h-7 w-7 hover:bg-neutral-200/20 dark:hover:bg-neutral-800/40 transition-colors duration-300"
                    >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="icon"
                className="h-6 w-6 transition-all duration-300 cursor-pointer hover:bg-neutral-200/40! hover:dark:bg-neutral-700/30! hover:text-neutral-700 dark:hover:text-neutral-100 group text-neutral-400 dark:text-neutral-500"
              >
                <MoreVertical className="h-3 w-3 transition-colors duration-300" />
              </Button>
            </DropdownMenuTrigger>
