      ...
      <SidebarHeader className="px-4 md:px-0.5 ">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              className="w-full gap-1 flex justify-center items-center shadow-none border-neutral-200 dark:border-neutral-700 hover:bg-neutral-200/10! dark:hover:bg-neutral-700/10"
              variant="outline"
            >
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Fill in the details for your new timeline.</DialogDescription>
            </DialogHeader>
              ...
              {data.mainNav.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton
                    ...
                    isActive={
                      currentView
                        ? item.title === 'Timelines' && currentView === 'Timeline'
                        : item.isActive
                    }
                  >
                    <a
                    ...
                    {item.items.map((subItem) => (
                      <SidebarMenuSubItem key={subItem.title}>
                        <SidebarMenuSubButton asChild isActive={pathname === subItem.url}>
                          <a
                            href={subItem.url}
                            onClick={(e) => subItem.isDisabled && e.preventDefault()}
                          >
