        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4 min-h-14 border-b dark:border-zinc-800 bg-white dark:bg-zinc-900/50 px-4 md:px-8 py-3 md:py-0 shrink-0">
          <div className="flex items-center gap-2 text-[13px] shrink-0">
            <span className="text-muted-foreground">
              Total: <span className="font-semibold text-foreground">17 Leads</span>
            </span>
            <span className="text-muted-foreground">•</span>
            <span className="text-muted-foreground">
              Closed: <span className="font-semibold text-foreground">8 Deals</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-3 overflow-x-auto overflow-y-hidden no-scrollbar w-full md:w-auto md:pb-0 shrink-0">
            <Tabs defaultValue="kanban" className="w-auto shrink-0">
              <TabsList className="h-8! rounded-lg bg-muted/50 border p-0">
                <TabsTrigger
                  value="kanban"
                  className="h-full w-9 p-0 rounded-lg data-[state=active]:bg-background data-[state=active]:shadow-xs hover:bg-muted/80 transition-colors duration-200 outline-none focus-visible:ring-0"
                >
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="h-8 px-2.5 rounded-lg gap-1.5 font-medium text-[13px] hover:bg-muted/50 transition-colors duration-200 shrink-0 outline-none focus-visible:ring-0"
                >
              ...
              <PopoverContent
                align="end"
                className="w-64 p-3 shadow-lg border-neutral-200 dark:border-zinc-800"
              >
            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  ...
                  <DialogDescription>Add a new lead to the Kanban board.</DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    <Input
                      id="company"
                      placeholder="e.g. Acme Corp Web Redesign"
                      className="focus-visible:ring-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none transition-colors"
                    />
                  </div>
                  <div className="grid gap-2">
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>Create a new lead card in this column.</DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                      <div className="grid gap-2">
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          id="desc"
                          placeholder="Brief details about the lead..."
                          className="focus-visible:ring-0 focus-visible:border-neutral-400 dark:focus-visible:border-neutral-600 outline-none shadow-none transition-colors"
                        />
                      </div>
                    </div>
