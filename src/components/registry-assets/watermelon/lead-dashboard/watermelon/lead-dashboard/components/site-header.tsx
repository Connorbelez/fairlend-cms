...
import { IconSearch, IconBell, IconSettings, IconUser, IconLogout } from '@tabler/icons-react'
    ...
    <header className="flex h-14 shrink-0 items-center justify-between border-b px-4 md:px-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <Popover>
          ...
          <PopoverContent
            align="end"
            className="w-80 p-0 overflow-hidden shadow-lg border-neutral-200 dark:border-zinc-800"
          >
            ...
            <div className="flex flex-col max-h-[300px] overflow-y-auto">
              <div className="p-4 flex gap-3 hover:bg-muted/50 transition-colors cursor-pointer border-b border-neutral-100 dark:border-zinc-800">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Sarah assigned the &apos;TechCorp&apos; lead to you.
                  </p>
              ...
              <div className="p-4 flex gap-3 hover:bg-muted/50 transition-colors cursor-pointer border-b border-neutral-100 dark:border-zinc-800">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    The &apos;OceanLabs&apos; deal was marked as closed won.
                  </p>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Avatar className="size-8 rounded-full shadow-sm cursor-pointer hover:opacity-90 transition-opacity">
              <AvatarImage src="" />
              <AvatarFallback className="bg-linear-to-br from-blue-400 via-purple-500 to-pink-500 text-white rounded-full">
                AJ
              </AvatarFallback>
            </Avatar>
          </PopoverTrigger>
          <PopoverContent
            align="end"
            className="w-56 p-1.5 shadow-lg border-neutral-200 dark:border-zinc-800"
          >
            <div className="flex items-center gap-2.5 px-2 py-2 mb-1 border-b border-neutral-100 dark:border-zinc-800/50 pb-3">
              <Avatar className="size-9 rounded-full">
                <AvatarImage src="" />
                <AvatarFallback className="bg-linear-to-br from-blue-400 via-purple-500 to-pink-500 text-white font-medium text-xs rounded-full">
                  AJ
                </AvatarFallback>
              </Avatar>
