  ...
  return (
    <Card className="border-none shadow-sm bg-zinc-100 dark:bg-zinc-800 rounded-none p-0.5 gap-0 group/card">
      <CardHeader className="flex flex-row items-center gap-2 p-2">
        ...
        <CardTitle className="text-md font-medium text-foreground">Payments</CardTitle>
      </CardHeader>
      <CardContent className="bg-white dark:bg-zinc-900 p-4 rounded-none">
        ...
        <div className="space-y-3">
          {data.map((item, i) => (
            <div
              key={i}
              className="flex justify-between items-center text-sm p-2 -mx-2 hover:bg-muted/50 rounded-md transition-colors duration-200 cursor-pointer group"
            >
        ...
        <div className="mt-8 flex justify-between items-center text-xs text-muted-foreground">
          <Popover>
            ...
            <PopoverContent
              align="start"
              className="w-80 p-0 rounded-none shadow-xl border border-zinc-200 dark:border-zinc-800"
            >
              <div className="p-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                <h4 className="font-semibold text-foreground">Detailed Breakdown</h4>
                <p className="text-xs text-muted-foreground">
                  Extended analytics for the current period.
                </p>
              </div>
              ...
              <div className="p-2 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                <Button
                  variant="ghost"
                  className="w-full h-8 text-xs font-medium justify-between group hover:bg-zinc-200/50 dark:hover:bg-zinc-800 rounded-none text-foreground"
                >
                  Open full analytics
          ...
          <span className="text-muted-foreground text-sm font-medium">Last updated 6h ago</span>
        </div>
      </CardContent>
    </Card>
  )
