    ...
    <Card className="w-full rounded-none shadow-sm p-0.5 bg-zinc-100 dark:bg-zinc-800 gap-0 border-none group/card">
      <CardHeader className="w-full px-2 mt-1">
        <div className="flex items-center gap-2 text-muted-foreground">
          ...
          <span className="text-lg font-medium text-foreground">Net revenue</span>
        </div>
      </CardHeader>
      <CardContent className="px-2 py-4 sm:px-4  bg-white dark:bg-zinc-900">
        <div className="flex items-baseline gap-2">
          <h2 className="text-2xl font-medium tracking-tight tabular-nums">₹18,46,720</h2>
          ...
          >
            <defs>
              <linearGradient id="fillNet" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="100%" stopColor="var(--color-net)" stopOpacity={0.01} />
              </linearGradient>
            </defs>
