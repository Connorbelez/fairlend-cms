            ...
            <DialogContent className="sm:max-w-[425px] rounded-none shadow-2xl p-0 overflow-hidden border-zinc-200 dark:border-zinc-800">
              <div className="p-6 pb-0">
                <DialogHeader>
                  ...
                  <DialogDescription>Start a manual payment or invoice.</DialogDescription>
                </DialogHeader>
              </div>
              <div className="p-6 grid gap-5">
                <div className="flex flex-col gap-2">
                  ...
                  <Input
                    ...
                    className="h-9 rounded-none bg-zinc-50 dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 focus-visible:ring-1"
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      type="number"
                      placeholder="0.00"
                      className="pl-7 h-9 rounded-none bg-zinc-50 dark:bg-zinc-900/50 border-zinc-200 dark:border-zinc-800 focus-visible:ring-1"
                    />
                  </div>
                </div>
                <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center justify-end gap-3 p-4 bg-zinc-50 dark:bg-zinc-900/50 border-t border-zinc-200 dark:border-zinc-800">
                <Button
                  variant="outline"
                  className="rounded-none h-9 text-xs font-medium hover:bg-zinc-100 dark:hover:bg-zinc-800"
                >
                  Cancel
                </Button>
                <Button
                  type="submit"
                  className="rounded-none h-9 text-xs font-medium bg-zinc-900 text-white hover:bg-zinc-800 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200 transition-colors"
                >
                  Create Transaction
                </Button>
              </div>
