      ...
      <CardHeader>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 space-y-2">
            ...
            <CardDescription>Daily sales count by channel, last {periodDays} days.</CardDescription>
          </div>
          <Select
            onValueChange={(v) => {
              const n = Number(v)
          ...
          >
            <SelectTrigger aria-label="Sales chart time range" className="w-full min-w-36 sm:w-fit">
          ...
          >
            ...
            <defs>
              ...
              <linearGradient id={idGradRetail} x1="0" x2="0" y1="0" y2="1">
                <stop offset="5%" stopColor="var(--color-retail)" stopOpacity={0.4} />
                <stop offset="95%" stopColor="var(--color-retail)" stopOpacity={0} />
              </linearGradient>
