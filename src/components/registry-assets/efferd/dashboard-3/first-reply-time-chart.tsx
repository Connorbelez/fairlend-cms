...
export function FirstReplyTimeChart({ className, ...props }: ComponentProps<typeof Card>) {
  return (
    <Card className={cn('shadow-none md:col-span-2 dark:ring-0', className)} {...props}>
      <CardHeader className="space-y-1">
        ...
        <CardDescription>Minutes to first agent message, last 7 days.</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            >
              <LabelList
                ...
                formatter={(label) => {
                  ...
                  return Number.isFinite(n) ? `${n.toFixed(1)}m` : String(label ?? '')
                }}
                offset={12}
                position="top"
              />
