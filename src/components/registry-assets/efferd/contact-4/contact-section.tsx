  ...
  return (
    <div className="relative mx-auto grid h-full w-full max-w-4xl rounded-2xl border md:grid-cols-[1fr_0.70fr]">
      <div className="col-span-1 flex flex-col space-y-4 p-8 lg:p-10">
        <h1 className="font-medium text-2xl tracking-wide md:text-3xl">Contact With Us</h1>
...
function ContactInfo({ icon, label, value, className, ...props }: ContactInfoProps) {
  return (
    <div className={cn('flex items-center gap-3 py-3', className)} {...props}>
      <div className="rounded-lg border bg-card p-3 shadow-xs [&_svg]:size-5">{icon}</div>
      <div>
