    ...
    <figure className="mx-auto flex w-full max-w-lg flex-col items-center justify-center md:grid md:grid-cols-[auto_1fr]">
      ...
      <figcaption className="space-y-4 p-8 text-center md:p-6 md:text-left">
        <blockquote className="text-lg text-muted-foreground leading-tight tracking-tight">
          &quot;<span className="font-medium text-foreground">Efferd</span> is so polished I might
          just retire. The ecosystem is in safe hands.&quot;
        </blockquote>

        <div>
          <cite className="font-medium text-foreground text-xs not-italic">Shadcn</cite>
          <div className="text-[10px] text-muted-foreground">Founder, shadcn/ui</div>
        </div>
      </figcaption>
    </figure>
  )
