  ...
  const content = (
    <>
      ...
      <span
        ...
        data-slot="cosmic-button-border"
      >
        <span className="absolute inset-[-200%] animate-cosmic-spin bg-[conic-gradient(from_0deg,#adfa1b,#c9ff63,#efffb7,#8cd413,#6f9f19,#92d61b,#adfa1b)] opacity-95 motion-reduce:animate-none" />
      </span>
      ...
      <span
        ...
        data-slot="cosmic-button-noise"
      >
        <span className="absolute inset-[-200%] animate-cosmic-spin-slow bg-[conic-gradient(from_180deg,#efffb7_0%,transparent_30%,#adfa1b_50%,transparent_70%,#7fbf17_100%)] motion-reduce:animate-none" />
      </span>
      ...
      <span
        ...
        data-slot="cosmic-button-content"
      >
        <span
          className="font-medium text-base tracking-wide text-foreground"
          data-slot="cosmic-button-label"
        >
