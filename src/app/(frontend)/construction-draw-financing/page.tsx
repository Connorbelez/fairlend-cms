...
export const metadata: Metadata = {
  title: 'Construction Draw Financing | DrawFlow | FairLend Mortgage',
  description:
  ...
  alternates: { canonical: '/construction-draw-financing' },
}
  ...
  return (
    <FairlendFeedbackContentPage
      config={{
        ...
        secondaryCta: { href: '/resources/construction-draws-small-builders', label: 'Read builder guide' },
        ...
        sections: [
          ...
          },
          {
            ...
            body:
              'Capital decisions get harder to trust when the file is scattered. One view of the roadmap, draws, evidence, and site status keeps the decision whole.',
            panels: [
              {
          ...
          },
          {
            ...
            body:
              "Field reality is messy. GPS drops, signals fail, sites are dead zones. DrawFlow keeps the evidence package intact regardless, flags it clearly when location can't be verified, and moves it to staff review, a site visit, or admin sign-off. Bad coordinates never cost you the proof.",
            checklist: [
